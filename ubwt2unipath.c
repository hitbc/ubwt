...
int ubwt2unipath_usage(void)
{
    ...
    err_printf("    -b          Output unipath in binary format. Default is FASTA format. [False].\n");
    err_printf("    -g          Output unipath in GTA format. [False]\n");
...
int ubwt2unipath(int argc, char *argv[])
{
    ...
    while ((c = getopt(argc, argv, "t:f:e:k:o:bgc:")) >= 0) {
        switch (c) {
